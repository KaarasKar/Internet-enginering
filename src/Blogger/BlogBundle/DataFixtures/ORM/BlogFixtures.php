...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setTags('symfony2, php, paradise');
        ...
        $blog2->setTags('pool, leaky, hacked, movie, hacking');
        $blog2->setCreated(new \DateTime("2015-07-23 06:12:33"));
        ...
        $blog3->setTags('misdirection, magic, movie, hacking');
        $blog3->setCreated(new \DateTime("2015-10-16 16:14:06"));
        ...
        $blog4->setTags('grid, daftpunk, movie');
        $blog4->setCreated(new \DateTime("2015-12-02 18:54:12"));
        ...
        $blog5->setCreated(new \DateTime("2015-12-20 15:34:18"));
